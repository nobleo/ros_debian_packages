```bash
echo "deb [trusted=yes] https://github.com/nobleo/ros_debian_packages/raw/noble-jazzy-amd64/ ./" | sudo tee /etc/apt/sources.list.d/nobleo_ros_debian_packages.list
